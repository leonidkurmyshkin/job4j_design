...
public class AnalyzeTest {
    ...
    public void whenNotChanged() {
        ...
        Set<User> current = Set.of(u3, u1, u2);
        assertThat(
    ...
    @Test
    public void whenOneChangedOneAdded() {
        User u1 = new User(1, "A");
        User u2 = new User(2, "B");
        User u3 = new User(3, "C");
        Set<User> previous = Set.of(u1, u2, u3);
    ...
    @Test
    public void whenChangedOnNull() {
        User u1 = new User(1, "A");
        User u2 = new User(2, "B");
        User u3 = new User(3, null);
        Set<User> previous = Set.of(u1, u2, u3);
        Set<User> current = Set.of(u1, new User(2, null), new User(3, "C"));
        assertThat(
                Analyze.diff(previous, current),
                is(new Info(0, 2, 0))
        );
